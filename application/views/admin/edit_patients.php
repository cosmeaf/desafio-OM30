      ...
      <div class="row mt-3">
        <div class="col">
          <div class="row">
            <div class="col-4">
              <div class="card p-5">
                <form action="<?= base_url();?>dashboard/patients/updateImage" method="post" enctype="multipart/form-data" accept-charset="utf-8">
               ...
               <input type="hidden" id="id" name="id" value="<?= $user['id']; ?>" /> 
               <button type="submit" class="btn btn-primary btn-block btn-sm"><i class="far fa-save"></i>&nbsp;&nbspAtualizar</button>
             </form>
           </div>
         </div>
         <div class="col-8">
...
<script>
  ...
  var req;
  const cnes = document.querySelector('#cnes')

  cnes.addEventListener("blur", function(event){
