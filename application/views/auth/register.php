...
<body>
	<div class="continer">
		<div class="row mt-2">
			<div class="offset-3 col-6 offset-md-4 col-md-4 mt-3">
						...
						<?php if ($this->session->flashdata('success')) : ?>
							...
							<form action="<?= base_url();?>register" method="post">
								...
								<div class="form-group">
									...
									<input type="email" class="form-control" id="email" name="email" placeholder="Enter e-mail" value="<?= set_value('email') ?>">
								...
								<div class="form-group">
									...
									<input type="password" class="form-control" id="passconf" name="passconf" placeholder="Repeat Password" autocomplete="true">
